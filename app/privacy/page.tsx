    ...
    <div style={{ backgroundColor: '#FDFDFB', minHeight: '100vh', padding: '60px 20px' }}>
      ...
      <div style={{ 
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '40px' }}>
          ...
          {/* Card 1: Introduction */}
          <div style={cardStyle}>
            <div style={iconHeaderStyle}><Zap size={24} /> <h2>Our Approach</h2></div>
            <p style={textStyle}>
          ...
          <div style={cardStyle}>
            <div style={iconHeaderStyle}><UserCheck size={24} /> <h2>What We Collect</h2></div>
          ...
          <div style={cardStyle}>
            <div style={iconHeaderStyle}><Eye size={24} /> <h2>How We Use It</h2></div>
          ...
          <div style={cardStyle}>
            <div style={iconHeaderStyle}><Lock size={24} /> <h2>Security & Sharing</h2></div>
            <p style={textStyle}>
