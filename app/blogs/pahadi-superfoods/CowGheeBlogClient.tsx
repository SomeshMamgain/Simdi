...
export function CowGheeBlogClient() {
    ...
    <div className="site-page-shell site-page-shell--hidden-overflow">
      ...
      <main style={{ maxWidth: '1100px', margin: '0 auto', padding: '120px 20px 80px' }}>
        <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '40px' }}>
          ...
          >
            {['en', 'hi'].map((language) => (
              <button
                key={language}
                onClick={() => setLang(language as 'en' | 'hi')}
                style={{
        ...
        <section style={{ marginBottom: '100px' }}>
          <h2 style={{ fontFamily: 'Georgia', fontSize: '2.5rem', color: '#1E2D24', marginBottom: '30px', textAlign: 'center' }}>
            {t.sec2Title}
          </h2>
          <div
            style={{
        ...
        <div style={{ background: '#1E2D24', padding: '70px 40px', borderRadius: '40px', color: '#fff', textAlign: 'center' }}>
          ...
          <div style={{ marginTop: '30px', display: 'flex', justifyContent: 'center', gap: '20px', color: '#A3B3A3', fontSize: '0.8rem' }}>
            <span style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
              <Heart size={14} fill="#B58E58" color="#B58E58" /> Traditional Method
            </span>
            <span style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
              <Star size={14} fill="#B58E58" color="#B58E58" /> Highly Rated
            </span>
            <span style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
              <Leaf size={14} fill="#B58E58" color="#B58E58" /> Preservative Free
            </span>
          </div>
        </div>
      </main>
