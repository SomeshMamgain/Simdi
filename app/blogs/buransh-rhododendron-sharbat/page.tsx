    ...
    <div className="site-page-shell site-page-shell--hidden-overflow">
      ...
      <main style={{ maxWidth: '1100px', margin: '0 auto', padding: '120px 20px 80px' }}>
        ...
        <div style={{ background: '#1E2D24', padding: '70px 40px', borderRadius: '40px', color: '#fff', textAlign: 'center' }}>
          ...
          <Link href="https://simdi.in/products/pahadi-blossom-juice" style={{ background: '#B58E58', color: '#fff', padding: '20px 50px', borderRadius: '5px', textDecoration: 'none', fontWeight: 'bold', display: 'inline-flex', alignItems: 'center', gap: '12px', letterSpacing: '0.1em' }}>
